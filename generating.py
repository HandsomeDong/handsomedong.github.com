...
posts = []
for f in onlyfiles:
    reader = open(join('./_posts/',f), 'r',encoding='utf-8')
...
front = open('./assets/data/front.gexf', 'r',encoding='utf-8').read()
end = open('./assets/data/end.gexf', 'r',encoding='utf-8').read()

graph_output = open('./assets/data/graph.gexf', 'w',encoding='utf-8')
...
for cate in categories:
    output = open('./_post_categories/'+cate+'.markdown', 'w',encoding='utf-8')
    output.write('--- \n')
